...
voteshare<- election_data_clean |>
  select(c(party_collect, votes, date_elec)) |> 
  summarise(TOTALvotos_poreleccion = sum(votes),
            .by = c(date_elec))

election_data_mika<-
  election_data_mika |> 
  left_join(voteshare, by = "date_elec") 
...
newggslopegraph(dataframe = election_data_mika,
                ...
                SubTitle = "Percentage share of votes per party for electrions from 2008 to 2019",
