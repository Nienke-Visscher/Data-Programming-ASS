...
abbrev_collect<-abbrev |> 
  mutate(party_collect = case_when(
    ...
    TRUE ~ siglas #If not any of these new abreviations than values from the siglas column
  ))
...
This chunk of code does not work and I cant seem o figure out why \[NIENLE\]
