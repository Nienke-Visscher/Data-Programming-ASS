 ...
 abbrev_collect<-abbrev |> 
  mutate(party_collect = case_when(
    ...
    str_detect(denominacion, "BILDU")|
      ...
      str_detect(denominacion, "UNIO") ~ "CU", # CONVERGÈNCIA I UNIÓ
...
election_data_clean<-election_data_clean|> 
  ...
  select(-tipo_eleccion, -codigo_distrito_electoral, -siglas) |> 
...
election_votes_sample <-election_data_sample |>
...
election_votes_sample <- election_votes_sample |> 
  group_by(date_elec) |> 
