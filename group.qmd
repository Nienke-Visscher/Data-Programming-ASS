...
survey_clean<-survey_clean |> 
  left_join(abbrev, by = c("party" = "siglas"))
...
```{r}
abbrev_disinct <- abbrev |> 
  left_join(survey_clean, by = c("siglas" = "party")) |> 
...
Joining survey_clean with election_data_clean

```{r}

survey_elec_data <- survey_clean |> 
   left_join(election_data_clean, by = c("party" = "siglas")) |> 
   select
```
